        ...
        <div className="mb-2 md:mb-3 flex flex-row md:flex-col gap-2">
          ...
          {people.length > 0 && (
            <Button
              ...
              className={`flex-1 md:w-full gap-1 md:gap-2 h-8 md:h-10 text-xs md:text-sm ${!splitEvenly ? 'hover:bg-primary hover:text-primary-foreground hover:border-primary' : ''}`}
            >
        ...
        {items.map((item) => {
          ...
          return (
            ...
            >
              <Card
                className={cn(
                  'p-2 md:p-4 space-y-1.5 md:space-y-3 border-2 transition-colors duration-100',
                  hasAssignments
