      ...
      <main className="container mx-auto max-w-3xl px-6 py-12 space-y-10">
        ...
        <Section title="2. Information We Collect">
          ...
          <ul className="list-disc list-inside space-y-1 pl-2">
            <li>
              Your name and email address from your Google account, or from Apple if you use
              Sign in with Apple
            </li>
            <li>A unique user ID generated by Firebase Authentication</li>
          </ul>
          <p>
            If you sign in with Apple and choose <span className="text-foreground">Hide My
            Email</span>, we only ever receive Apple's private relay address, never your real
            one. Friends will not be able to find you by email address in that case — they can
            search for your username instead.
          </p>
