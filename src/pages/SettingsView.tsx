      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="flex flex-col flex-1 min-h-0 w-full">
        ...
        <TabsContent value="profile" className="data-[state=active]:flex-1 min-h-0 overflow-y-auto scrollbar-hide mt-4 pb-4">
          <div className="space-y-4">
            <ProfileSettingsCard />
            {/*
              Adding a password is how an Apple user reaches their account from
              a web browser at all — Sign in with Apple is iOS-only. Keep it
              above the delete card so it reads as account management, not as
